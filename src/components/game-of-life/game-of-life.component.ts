...
export class GameOfLifeComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        Promise.all(promises)
            .then(([memoryModule, universeModule]) => {
    ...
    drawGosperGliderGun() {
        ...
        const gliderGunCells = [
            [1,6], [2,6], [1,7], [2,7],
            [13,4], [14,4], [12,5], [11,6], [11,7], [11,8], [12,9], [13,10], [14,10],
            [15,7], [16,5], [17,6], [17,7], [17,8], [16,9], [18,7],
            [21,4], [21,5], [21,6], [22,4], [22,5], [22,6], [23,3], [23,7],
            [25,2], [25,3], [25,7], [25,8],
            [35,4], [35,5], [36,4], [36,5]
        ]
        const cellsPtr = this.universe.cells();
    ...
    drawHammerhead() {
        ...
        const hammerheadCells = [
            [10,9], [11,9], [9,10], [10,10], [12,10], [13,10], [14,10],
            [10,11], [11,11], [12,11], [13,11], [14,11],
            [11,12], [12,12], [13,12], [14,12], [15,12],
            [15,13], [16,13], [17,13], [15,14], [16,14], [17,14], [15,15], [16,15], [17,15],
            [15,18], [16,18], [17,18], [15,19], [16,19], [17,19], [15,20], [16,20], [17,20],
            [11,21], [12,21], [13,21], [14,21], [15,21],
            [10,22], [11,22], [12,22], [13,22], [14,22],
            [10,24], [11,24], [9,23], [10,23], [12,23], [13,23], [14,23],

            [19,13], [19,15], [20,15], [21,15], [19,16], [20,16], [19,17], [20,17], [19,18], [20,18], [21,18], [19,20],
            [21,12], [21,13], [22,13], [22,14], [21,20], [21,21], [22,20], [22,19],
            [23,12], [24,12], [25,12], [26,12], [27,11], [27,9], [25,8], [23,9], [22,10], [22,11],
            [23,21], [24,21], [25,21], [26,21], [27,22], [27,24], [25,25], [23,24], [22,23], [22,22],
        ];
        const cellsPtr = this.universe.cells();
        const cells = new Uint8Array(this.memory.buffer, cellsPtr, this.width * this.height);
